...
# ── 採用方向（ラベンダー系）のバリエーション ──
build "04-lavender-blue"    "#8f93c0" "#62669a" "#4c4f63" "#272834" "#252634" "#f8f9fc" "#eceef5" "#e2e4f0" "#bfc2d9" "#d3d6e8" "143,147,192" "190,193,225" "98,102,154"
build "05-lavender-mauve"   "#b08fae" "#856488" "#5c4f5a" "#2f2830" "#2e2630" "#fcf8fb" "#f4ebf2" "#efe0ec" "#d6bed3" "#e6d2e2" "176,143,174" "220,195,217" "133,100,136"
build "06-lavender-iris"    "#8674ad" "#5e4f86" "#4d465c" "#292533" "#272233" "#f9f7fc" "#ede9f4" "#e3dcf0" "#c4bad8" "#d8cce8" "134,116,173" "195,182,216" "94,79,134"
